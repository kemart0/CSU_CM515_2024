...
#instead of clicking through all the tabs it will put it in a table
...
#need to find the appropriate table from the webpage
data7 <- html_table(tables[10])
#list of nodes, make it a data frame and then we can actually read it!
